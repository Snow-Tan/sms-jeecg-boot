    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="用户账号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input placeholder="请输入用户账号" v-decorator.trim="[ 'username', validatorRules.username]" :disabled="true"/>
        </a-form-item>
        ...
        <a-form-item label="工号" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input :disabled="true" placeholder="请输入工号" v-decorator.trim="[ 'workNo', validatorRules.workNo]" />
        </a-form-item>

        <a-form-item label="职务" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-select-position :disabled="true" placeholder="请选择职务" :multiple="false" v-decorator="['post', {}]"/>
        </a-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        if (!record){
          //取 pro__Login_Userinfo 存储的用户
          let loginUser = localStorage.getItem("pro__Login_Userinfo");
